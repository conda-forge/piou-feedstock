...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/piou-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14863&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/piou-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `piou` can be installed with:

```
conda install piou
```

It is possible to list all of the versions of `piou` available on your platform with:
